...
class WorkspacePageEmbedderSettings:
    ...
    def get_settings() -> dict:
        """Get all settings."""
        settings = frappe.get_doc("Workspace Page Embedder Settings", "Workspace Page Embedder Settings") if frappe.db.exists("Workspace Page Embedder Settings", "Workspace Page Embedder Settings") else {}
        return settings
